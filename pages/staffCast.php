...
<div id="content">
	<div class="padded">
		...
		<ul>
			<li>Built for CFOs, FDs, HR leads, and budget owners</li>
			<li>Forecasts monthly people costs based on real contracts</li>
			<li>Highlights actuals, outturn, and variance</li>
			<li>Includes Employer's NI, Employer's Pension Contributions, Capitalisation, and more</li>
		</ul>
	...
	<div class="padded">
		...
		<ul>
			<li>
				<h2>Save Time</h2>
				<p>Spend less time wrangling spreadsheets - and more time on decisions.</p>
			</li>
			<li>
				<h2>Improve Accuracy</h2>
				<p>Get numbers you can trust, backed by real data and assumptions</p>
			</li>
			<li>
				<h2>Empower Managers</h2>
				<p>Let budget owners see what's happening in their teams, and update their assumptions, instantly</p>
			</li>
		</ul>
	</div>
</div>

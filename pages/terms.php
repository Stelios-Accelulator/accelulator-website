	...
	<ol class="decimal-points">
		...
		<li>
			...
			<ol>
				...
				<li>As a client/subscriber we may also, in the future, send you a newsletter/email or similar and we find that most clients/subscribers find this helpful. We rely upon the 'legitimate interest' we have in maintaining contact with former clients/subscribers to do this in data protection law and your agreement for the purposes of the Privacy & Electronic Communications Regulation (which can be implied under these Regulations). However we will never share your information with third parties to market to you and will not contact you about non-relevant services/subscriptions. We will make it quick and easy to 'opt out' of future communications in every communication sent. If you already know that you don't want to receive these messages, then you can opt out now by emailing <a href="mailto:contact@accelulator.com">contact@accelulator.com.</a></li>

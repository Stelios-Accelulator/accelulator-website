...
<div class="padded">
	...
	<p>Cookies may store information about how the site is used, which can be used for maintenance and improvement. They simply log numbers and provide grouped information about the site and how people interact with the website and services offered.</p>
	<p>The data collected by cookies and similar technologies may be used to provide personalised promotion offers to you (based on our legitimate interests). For instance, we may do this in order to send you relevant offers and promotions by email (where you permit us to do so).</p>
	<p>You may reject cookies and disable similar technologies. However, website functions will be affected. Cookies and similar technologies enable our site to work properly and personlise your experience. You will be able to access the website without them but considerable levels of functionality and safety will be degraded by disallowing the use of these technologies.</p>
	<p>By accepting cookies, you allow us to improve your experience and remember information about you, which can personalise your experience.</p>

<div class="padded">
	  ...
	  <section class="hero">
		<h1>What if your people costs were always right?</h1>
		<p>With StaffCast, they are. Forecast payroll with confidence — no spreadsheets, no surprises.</p>
		<button class="btn-primary" onClick="loadRegistrationForm();">Try StaffCast</button>
		<button class="btn-secondary">See how it works</button>
	  </section>
	
	  <section class="section">
		<h2>Built for busy finance and HR teams</h2>
		<div class="features">
